/*
  ...
  This file must stay byte-identical to the device's copy at
  src/engine/fold.ts in the DurusIOS repo. A constant that
...
import { DEFAULT_STATE, schedule, type Grade, type SrsState } from "@/lib/srs";
