        ...
        {KEYS.map((key, i) =>
          key === "" ? (
            ...
            <button
              ...
              className="border-rule bg-surface active:bg-surface-sunk flex size-[72px] items-center justify-center rounded-[999px] border transition-colors disabled:opacity-40"
            >
              {key === "del" ? (
